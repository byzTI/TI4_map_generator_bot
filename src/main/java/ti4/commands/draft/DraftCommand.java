...
public class DraftCommand implements Command {
    ...
    private final Collection<DraftSubcommandData> subcommandData = getSubcommands();
    ...
    public void execute(SlashCommandInteractionEvent event) {
        ...
        DraftSubcommandData executedCommand = null;
        for (DraftSubcommandData subcommand : subcommandData) {
    ...
    private Collection<DraftSubcommandData> getSubcommands() {
        Collection<DraftSubcommandData> subcommands = new HashSet<>();
        subcommands.add(new Draft());
